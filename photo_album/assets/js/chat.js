...
$(document).ready(function() {
    ...
    var albumBucketName = "2021awsassignment2";
    var bucketRegion = "us-west-2";
    var IdentityPoolId= "us-west-2:221d9c10-98c9-4f8d-bd36-4606dbbbe6a3";
    ...
    function search_from_AWS(extracted_text){
        ...
        console.log("Response from API Gateway:" + response)
		image_bucket = "https://2021awsassignment2.s3.us-west-2.amazonaws.com/"
        response.then(function(result) {
			console.log("LOG: result: " + result)
            labels = result.data.split('_');
            ...
            if (labels.length == 0){
                ...
                for(var i=0;i < labels.length; i++) {
                    // var arrValue = list[i].innerHTML;
                    // alert(arrValue);
                    console.log("LOG: labels[i]: " + labels[i])
                    appendImage(image_bucket + labels[i])
                }
            }
         })
    }
